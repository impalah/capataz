...
from capataz_api.adapters.inbound.routers.connectors import router as connectors_router
...
from capataz_api.adapters.inbound.routers.resources import router as resources_router
