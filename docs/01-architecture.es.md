...
- **Integraciones**: todo destino saliente (URLs de health, URLs de conectores, hosts SSH) se valida contra SSRF, las credenciales de integración son recursos cifrados del catálogo y Portainer solo opera contenedores resueltos desde el catálogo.
